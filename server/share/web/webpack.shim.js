...
let webpackShimConfig = {
  ...
  resolveAlias: {
    ...
    'pgadmin.browser.performance_diagnostic': path.join(__dirname, './pgadmin/pem/tools/performance_diagnostic/static/js/'),
    ...
    // PEM related aliases
    'pem': path.join(__dirname, './pgadmin/pem/static/js/'),
    'pem.charts': path.join(__dirname, './pgadmin/pem/static/js/modules/Charts/'),
    'pem.management.manage_alerts': path.join(__dirname,
      './pgadmin/pem/static/js/modules/Alerts'),
    'pem.management.manage_profiles': path.join(__dirname,
      './pgadmin/pem/static/js/modules/Profiles'),
    'pem.management.manage_probes': path.join(__dirname,
      './pgadmin/pem/static/js/modules/Probes'),
    'pem.management.scheduled_tasks': path.join(__dirname,
      './pgadmin/pem/static/js/modules/Management/scheduled_tasks'),
    'pem.tools.report': path.join(
      __dirname,
      './pgadmin/pem/tools/reports'
    ),
    'pem.server_groups': path.join(__dirname, './pgadmin/browser/server_groups'),
    'pem.node.agent': path.join(__dirname, './pgadmin/browser/server_groups/agents/static/js/agent'),
    'pem.node.pem_job': path.join(__dirname, './pgadmin/browser/server_groups/agents/jobs/static/js/pem_job'),
    'pem.node.jobstep': path.join(__dirname, './pgadmin/browser/server_groups/agents/jobs/steps/static/js/pem_jobstep'),
    'pem.node.jobschedule': path.join(__dirname, './pgadmin/browser/server_groups/agents/jobs/schedules/static/js/pem_jobschedule'),
    'pem.file.server_configuration': path.join(__dirname, './pgadmin/pem/static/js/modules/Alerts/ServerConfigs'),
    'pem.management.audit_manager':
      path.join(__dirname, './pgadmin/pem/static/js/modules/Management/AuditManager'),
    'sources/test': path.join(__dirname, './regression/javascript/'),
    'pem.node.barman_server': path.join(__dirname, './pgadmin/browser/barman_servers/static/js/barman_server'),
    'pem.management.log_manager':
    path.join(__dirname, './pgadmin/pem/static/js/modules/Management/LogManager'),
    'pem.management.schedule_alert_blackout':
    path.join(__dirname, './pgadmin/pem/static/js/modules/Management/ScheduleAlertBlackout'),
    'pem.monitoring.auto_discovery': path.join(__dirname, './pgadmin/pem/static/js/modules/Monitoring/AutoDiscovery'),
    'pem.management.capacity_manager':
    path.join(__dirname, './pgadmin/pem/static/js/modules/Management/CapacityManager'),
    'pem.management.manage_charts':
    path.join(__dirname, './pgadmin/pem/static/js/modules/Management/ManageCharts'),
  },
  externals: [
    ...
    'sources/generated/pem_alert_config',
    'pem.monitor.dashboard.list',
  ],
