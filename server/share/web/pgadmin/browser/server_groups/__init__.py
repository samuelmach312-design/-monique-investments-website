...
from pgadmin.browser.server_groups.pem import \
    PEMServerGroupModule, PEMServerGroupMenuItem, \
    PEMServerGroupPluginModule, PEMServerGroupView
from . import api
...
class ServerGroupModule(BrowserPluginModule):
    ...
    def register(self, app, options):
        ...
        from .clusters import blueprint as module
        self.submodules.append(module)
        super().register(app, options)
...
blueprint = PEMServerGroupModule(__name__)
...
PEMServerGroupView.register_node_view(blueprint)
