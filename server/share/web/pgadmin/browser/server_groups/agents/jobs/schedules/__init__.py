...
"""Implements pemAgent Job Schedule Node"""
...
from .utils import format_schedule_data
...
class JobScheduleModule(CollectionNodeModule):
    ...
    * node_inode()
    ...
    def script_load(self):
        """
        Load the module script for schedule, when any of the pem.job
    ...
    * delete(gid, agid, jid, jscid)
    ...
    def check_precondition(f):
        ...
        def wrap(self, *args, **kwargs):
            ...
            self.template_path = 'pem_jobschedules/sql'
    ...
    @check_precondition
    def nodes(self, gid, agid, jid, jscid=None):
        """
    ...
    @check_precondition
    def properties(self, gid, agid, jid, jscid):
        """
    ...
    @check_precondition
    def update(self, gid, agid, jid, jscid):
        """
        This function will update the data for the selected schedule node.
    ...
    @check_precondition
    def delete(self, gid, agid, jid, jscid=None):
    ...
    @check_precondition
    def msql(self, gid, agid, jid, jscid=None):
        """
        This function is used to return modified SQL for the
        selected Schedule node.
    ...
    @check_precondition
    def sql(self, gid, agid, jid, jscid):
        """
