...
from pgadmin.browser.server_groups.servers.databases.pem import \
    PemDatabaseModule, PemDatabaseView
...
SchemaDiffRegistry(blueprint.node_type, PemDatabaseView)
PemDatabaseView.register_node_view(blueprint)
