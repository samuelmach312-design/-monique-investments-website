...
function Wizard({ stepList, onStepChange, onSave, className, ...props }) {
  ...
  React.useEffect(() => {
    ...
    if (props.disableBackStep) {
      setDisableBack(props.disableBackStep(activeStep));
    }
  });
    ...
    <StyledBox>
      ...
      <div className='Wizard-footer'>
        <Box className='Wizard-actionBtn' marginLeft="auto">
          <DefaultButton onClick={handleBack} disabled={activeStep === 0 || disableBack} className='Wizard-buttonMargin' startIcon={<FastRewindIcon />}>
            {gettext('Back')}
          </DefaultButton>
...
Wizard.propTypes = {
  ...
  disableBackStep: PropTypes.func,
