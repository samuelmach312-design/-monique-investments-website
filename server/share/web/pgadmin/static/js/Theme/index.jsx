...
import pemOverride from './overrides/pem.classes.override';
import pemVariables from './overrides/pem.variables';
        ...
        styleOverrides: {
          root: {
            ...
            '&.Mui-selected': {
              backgroundColor: baseTheme.palette.primary.light,
              borderColor: baseTheme.palette.primary.main,
              color: basicSettings.palette.getContrastText(
