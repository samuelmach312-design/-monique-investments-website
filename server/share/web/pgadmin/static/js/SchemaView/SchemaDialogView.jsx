...
export default function SchemaDialogView({
  ...
  const getButtonIcon = () => {
    ...
    }else if(props.customSaveBtnIconType == 'no-icon') {
      return null;
    }
    else if(props.customSaveBtnIcon) {
      return props.customSaveBtnIcon;
    }
    return <SaveIcon />;
  };
...
SchemaDialogView.propTypes = {
  ...
  customSaveBtnIcon: PropTypes.node,
