...
export const createFieldControls = ({
  ...
  const parentDisabled = viewHelperProps?.disableChildFields ?? false;
  // Pem Specific change lets you disable all successive child schemas from parent
  const disableChildFields = (schema.disableChildFields ?? false) || parentDisabled;
  ...
  schema?.fields?.forEach((field) => {
        ...
        if (!inlineGroup) {
          inlineGroup = currentGroup.inlineGroups[inlineGroupId] = {
            ...
            controlProps: {
              viewHelperProps: {
                ...viewHelperProps,
                disableChildFields: disableChildFields,
              },
              field: null,
            },
            controls: [],
    ...
    default:
      ...
      if (field.id) {
        ...
        controlProps['field']['disabled'] = disableChildFields || controlProps.field.disabled;
