...
import unittest
import config
from .extended_test_generator import override_base_test_generator
        ...
        for module_name in all_modules:
            try:
                if "tests." in str(module_name) and not any(
                    ...
                    if module_name != 'pgadmin.pem.utils.tests.utils':
...
# Overriding the BaseTestGenerator (PEM Specific)
override_base_test_generator()
