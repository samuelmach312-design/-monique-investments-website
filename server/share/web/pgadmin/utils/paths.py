...
def create_users_storage_directory():
    ...
    # it throws circular import error.
    import config
    # To avoid cyclic import, importing it at runtime (PEM specific)
    ...
    for usr in users:
        ...
        # PEM 9.8 and earlier did not save username for some of the users.
        # We may find the users in upgrade scenario.
        # Ignoring them.
