...
# for Search Objects privilege of PEM
searchObjectsTool = PEMRole(
    'pem_search_objects_tool', gettext('Search Objects Tool'),
    gettext('Search Objects Tool role'),
    gettext('Priviledge to access Search Objects Tool functionalities')
)
