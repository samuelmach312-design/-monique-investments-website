...
from pgadmin.pem.utils import Server
...
# for Import/Export Data privilege of PEM
importExportDataToolRole = PEMRole(
    'pem_import_export_data_tool', _('Import/Export Data Tool'),
    _('Import/Export Data role'),
    _('Priviledge to access Import/Export Data functionalities')
)
...
class IEMessage(IProcessDesc):
    ...
    def get_server_name(self):
        ...
        # for PEM getting server details is different than pgAdmin
