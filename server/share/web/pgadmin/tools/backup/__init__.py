...
# for Backup Tool privilege of PEM
backupToolRole = PEMRole(
    'pem_backup_tool', gettext('Backup Tool'),
    gettext('Backup Tool role'),
    gettext('Priviledge to access Backup Tool functionalities')
)
