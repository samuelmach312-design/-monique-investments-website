...
# for Maintenance privilege of PEM
maintenanceToolRole = PEMRole(
    'pem_maintenance_tool', _('Maintenance Tool'),
    _('Maintenance Tool role'),
    _('Priviledge to access Maintenance Tool functionalities')
)
