...
# Load configuration created by configure-pem-server.sh
try:
    import config_setup
    config_setup_settings = get_variables_from_module('config_setup')
    custom_config_settings.update(config_setup_settings)
except ImportError:
    pass
