...
def upgrade():
    ...
    # PEM does not require to have default user
    ...
    # PEM: Does not require username in the user table by default.
    ...
    # PEM: Does not have default user with id #1, hence - these two entries are
    # not required.
