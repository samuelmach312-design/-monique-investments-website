...
#
# Copyright (C) 2013 - 2025, EnterpriseDB Corporation. All rights reserved.
#
...
LANGUAGES = {
    'en': 'English',
    # PEM only supports 'English' as language for now.
...
# On Windows, we always store data in %APPDATA%\$(APP_WIN_PATH). On Linux
# platforms, we use ${HOME}/.pem (/var/lib/pemhome/.pem/)
if IS_WIN:
...
##########################################################################
# FIPS 140-3 encryption means to use new encryption version (>=20251125)
##########################################################################
SUPPORT_FIPS_140_3_ENCRYPTION_ONLY = True
...
AUTHENTICATION_SOURCES = ['pem_internal']
