...
module.exports = [{
  ...
  entry: {
    ...
    // pem
    profiler: './pgadmin/pem/tools/profiler/static/js/index.js',
    performance_diagnostic: './pgadmin/pem/tools/performance_diagnostic/static/js/index.js',
  },
      ...
      use: {
        ...
        options: {
          ...
          imports: [
            ...
            'pure|pem.management.manage_alerts',
            'pure|pem.management.manage_probes',
            'pure|pgadmin.browser.performance_diagnostic',
            'pure|pem.management.scheduled_tasks',
            'pure|pem.node.agent',
            'pure|pem.node.pem_job',
            'pure|pem.node.jobstep',
            'pure|pem.node.jobschedule',
            'pure|pem.file.server_configuration',
            'pure|pem.management.audit_manager',
            'pure|pem.tools.report',
            'pure|pem.node.barman_server',
            'pure|pem.management.log_manager',
            'pure|pem.management.schedule_alert_blackout',
            'pure|pem.management.capacity_manager',
            'pure|pem.monitoring.auto_discovery',
            'pure|pem.management.manage_charts',
          ],
        },
      },
    },
